# TaaskMaster - Aplicación de Gestión de Tareas
...
- :calendar: Asignación de fechas limite y prioridades.
  - Prioridad baja, media y alta.
  - Fecha límite personalizadas con control de calendario.
...
- $E$ es la eficiencia en procentaje
...
![Interfaz de usuario](imagen.png)
...
Si deseas que el título de la tarea sea visible en negrita, escríbelo entre dobles asteriscos: `**Título de
la Tarea**`.
...
Desarrollado por [Damien Bruth Pintos](https://github.com/damien18bp)
